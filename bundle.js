(() => {
  ...
  var _getTarget = function _getTarget2(t) {
    return _toArray(t)[0] || (_isString3(t) ? console.warn("Element not found:", t) : null);
  };
  ...
  gsapWithCSS.fromTo(".shore .sea_bg", { background: "linear-gradient(180deg, #71a7f4 5.55%, #5981ff 87.36%)" }, {
  ...
  gsapWithCSS.fromTo(".shore .sea_bg", { background: "linear-gradient(180deg, #535575 5.54%, #637395 87.35%)" }, {
  ...
  var rocks3 = gsapWithCSS.utils.toArray(".rocks3");
  var rocks2 = gsapWithCSS.utils.toArray(".rocks2");
  var rocks4 = gsapWithCSS.utils.toArray(".rocks4");
  rocks4.forEach((rock) => {
    gsapWithCSS.to(rock, {
      xPercent: -70,
      ease: "none",
